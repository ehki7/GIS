...
<head>
  ...
  <title>GIS SMAN & SMKN SURABAYA</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/kemdikbud.png" rel="icon">
  <link href="assets/img/kemdikbud.png" rel="apple-touch-icon">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>GIS</span></a></h1>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-3 d-flex align-items-center" data-aos="zoom-in" data-aos-delay="100">
            <img src="assets/img/slider.jpg" class="img-fluid" alt="" style="opacity: 0;">
          </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p>
              Dalam aplikasi pemetaan geografis sekolah menengah ini memuat informasi dan lokasi dari SMA dan SMK Negeri di Surabaya. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing" sekolah. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
            <ul>
      ...
      <div class="container">
        ...
        <div class="panel-body" style="align-content: center;">
          <div id="map" style="width:100%;height:480px;"></div>
            <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyASpCyPQ74xUKIpo3sKbMlsIp9XG8l-hmo"></script>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>SIG SMAN & SMKN SURABAYA</h3>
            <p>
             SBY, ID<br><br>
              <strong>Phone:</strong> +62 8100001111<br>
              <strong>Email:</strong> localhost@mail.com<br>
            </p>
          </div>
